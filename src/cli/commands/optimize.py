...
def register(subparsers):
    parser = subparsers.add_parser("optimize", help="调整单条 CDS 的 GC，或批量消除限制酶位点、超长同聚物")
    ...
    mode.add_argument("--homopolymer-max", type=int, metavar="NT", help="批量限制所有 CDS 连续相同碱基的最大长度，例如 6；必须是正整数")
